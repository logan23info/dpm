      ...
      <main className="max-w-6xl mx-auto px-4 pb-10">
        ...
        {activeTab === "details" && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {/* Auto-Draft Finding */}
            {workpaper.test_result && workpaper.test_result !== 'effective' && workpaper.test_result !== 'not-tested' && (
              <div className="bg-white rounded-xl border border-slate-200 p-5">
                ...
                {!autoDraft ? (
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-xs text-amber-700">⚠️ Review and edit the draft before saving</p>
